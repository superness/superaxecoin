      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->superaxecoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->superaxecoinAtStartup);
    ...
    ui->superaxecoinAtStartup->setToolTip(ui->superaxecoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->superaxecoinAtStartup->setText(ui->superaxecoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openSuperAxeCoinConfButton->setToolTip(ui->openSuperAxeCoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new SuperAxeCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->superaxecoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSAXEontrols);
...
void OptionsDialog::on_openSuperAxeCoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openSuperAxeCoinConf())
