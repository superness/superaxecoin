...
#ifndef SUPERAXECOIN_KERNEL_VALIDATION_CACHE_SIZES_H
#define SUPERAXECOIN_KERNEL_VALIDATION_CACHE_SIZES_H
...
#endif // SUPERAXECOIN_KERNEL_VALIDATION_CACHE_SIZES_H
