...
""" Interactive superaxecoind P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for SuperAxeCoin Core can enable. It uses BCC
...
def main(superaxecoind_path):
    ...
    superaxecoind_with_usdts.enable_probe(
