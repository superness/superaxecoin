...
Verify that a superaxecoind node can use an external signer command.
...
class RPCSignerTest(SuperAxeCoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart superaxecoind with -signer=<cmd>',
