...
export CONTAINER_NAME=ci_native_nowallet_libsuperaxecoinkernel
...
export GOAL="install"
export SUPERAXECOIN_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
