SuperAxeCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/superaxecoin/files/SuperAxeCoin/superaxecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the SuperAxeCoin
...
New/changed settings (command-line or superaxecoin.conf file)
--------------------------------------------------------
