SuperAxeCoin Core version *0.15.2* is now available from:

  <https://superaxecoincore.org/bin/superaxecoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in superaxecoin-tx (TheBlueMatt)
