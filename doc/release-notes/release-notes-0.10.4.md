SuperAxeCoin Core version 0.10.4 is now available from:

  <https://superaxecoin.org/bin/superaxecoin-core-0.10.4/>
...
- #6953 `43c2789` Split superaxecoin-tx into its own package
- #6953 `dfe0d4d` Include superaxecoin-tx binary on Debian/Ubuntu
