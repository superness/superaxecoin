SuperAxeCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/superaxecoin/files/SuperAxeCoin/superaxecoin-0.5.4/
...
http://gitorious.org/superaxecoin/superaxecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix SuperAxeCoin-Qt notifications under Growl 1.3.
Increase required age of SuperAxeCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSuperAxeCoin properly when installing SuperAxeCoin-Qt over it. (Windows)
