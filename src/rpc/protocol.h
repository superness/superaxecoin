...
#ifndef SUPERAXECOIN_RPC_PROTOCOL_H
#define SUPERAXECOIN_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in superaxecoind
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< SuperAxeCoin is not connected
...
#endif // SUPERAXECOIN_RPC_PROTOCOL_H
