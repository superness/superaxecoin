...
#ifndef SUPERAXECOIN_NODE_CONNECTION_TYPES_H
#define SUPERAXECOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/superaxecoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on SuperAxeCoin’s Peer-to-Peer Network")
...
#endif // SUPERAXECOIN_NODE_CONNECTION_TYPES_H
