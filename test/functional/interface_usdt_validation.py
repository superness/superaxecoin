...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/superaxecoin/superaxecoin/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(SuperAxeCoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/superaxecoin/superaxecoin/blob/master/doc/tracing.md#tracepoint-validationblock_connected
