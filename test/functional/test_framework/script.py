...
This file is modified from python-superaxecoinlib.
"""
...
def bn2vch(v):
    """Convert number to superaxecoin-specific little endian format."""
...
def FindAndDelete(script, sig):
    """Consensus critical, see FindAndDelete() in Axoshi codebase"""
    r = b''
