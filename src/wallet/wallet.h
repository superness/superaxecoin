...
#ifndef SUPERAXECOIN_WALLET_WALLET_H
#define SUPERAXECOIN_WALLET_WALLET_H
...
//! Discourage users to set fees higher than this amount (in axoshis) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in axoshis)
...
public:
    ...
    /** Absolute maximum transaction fee (in axoshis) used by default for the wallet */
...
#endif // SUPERAXECOIN_WALLET_WALLET_H
