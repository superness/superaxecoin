...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/superaxecoin/superaxecoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(SuperAxeCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our superaxecoind node")
