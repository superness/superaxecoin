...
#ifndef SUPERAXECOIN_SCRIPT_MINISCRIPT_H
#define SUPERAXECOIN_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a superaxecoin script
...
#endif // SUPERAXECOIN_SCRIPT_MINISCRIPT_H
