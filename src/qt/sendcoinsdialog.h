...
#ifndef SUPERAXECOIN_QT_SENDCOINSDIALOG_H
#define SUPERAXECOIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending superaxecoins */
...
#endif // SUPERAXECOIN_QT_SENDCOINSDIALOG_H
