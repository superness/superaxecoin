#!/usr/bin/env python3
# Copyright (c) 2021-present The SuperAxeCoin Core developers
...
to a hash that has been compiled into superaxecoind.
...
class AssumeutxoTest(SuperAxeCoinTestFramework):
