...
class TransactionTimeRescanTest(SuperAxeCoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine AXE and create transactions
        ...
        # generate some axe to create transactions and check blockcount
        ...
        # send 10 axe to user's first watch-only address
        self.log.info('Send 10 axe to user')
        ...
        # send 5 axe to our second watch-only address
        self.log.info('Send 5 axe to user')
        ...
        # send 1 axe to our third watch-only address
        self.log.info('Send 1 axe to user')
