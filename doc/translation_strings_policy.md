...
This document provides guidelines for internationalization of the SuperAxeCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `superaxecoin_en.ts` remains unchanged.
