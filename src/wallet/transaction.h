...
#ifndef SUPERAXECOIN_WALLET_TRANSACTION_H
#define SUPERAXECOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this superaxecoin node, and set to 0 for transactions that were created
...
#endif // SUPERAXECOIN_WALLET_TRANSACTION_H
