...
#ifndef SUPERAXECOIN_IPC_PROCESS_H
#define SUPERAXECOIN_IPC_PROCESS_H
...
//! IPC process interface for spawning superaxecoin processes and serving requests
...
#endif // SUPERAXECOIN_IPC_PROCESS_H
