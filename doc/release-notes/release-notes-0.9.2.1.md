SuperAxeCoin Core version 0.9.2.1 is now available from:

  https://superaxecoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 AXE to 0.01 AXE
...
- Fix "Start superaxecoin on system login"
