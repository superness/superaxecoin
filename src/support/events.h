// Copyright (c) 2016-2018 The SuperAxeCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef SUPERAXECOIN_SUPPORT_EVENTS_H
#define SUPERAXECOIN_SUPPORT_EVENTS_H
...
#endif // SUPERAXECOIN_SUPPORT_EVENTS_H
