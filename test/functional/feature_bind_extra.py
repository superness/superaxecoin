...
"""
Test starting superaxecoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(SuperAxeCoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that superaxecoind has bound on "::1" (for RPC) and "::" (for P2P).
