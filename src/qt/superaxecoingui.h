...
#ifndef SUPERAXECOIN_QT_SUPERAXECOINGUI_H
#define SUPERAXECOIN_QT_SUPERAXECOINGUI_H
...
/**
  SuperAxeCoin GUI main class. This class represents the main window of the SuperAxeCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SuperAxeCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SuperAxeCoinGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~SuperAxeCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a superaxecoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, SuperAxeCoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed SuperAxeCoin Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(SuperAxeCoinUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // SUPERAXECOIN_QT_SUPERAXECOINGUI_H
