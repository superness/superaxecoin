...
//! Entry point for SuperAxeCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &SuperAxeCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for SuperAxeCoinGUI tests.
void AppTests::guiTests(SuperAxeCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &SuperAxeCoinGUI::consoleShown, this, &AppTests::consoleTests);
