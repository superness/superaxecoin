SuperAxeCoin Core version 0.9.4 is now available from:

  https://superaxecoin.org/bin/0.9.4/
...
this update is incompatible with the SuperAxeCoin system and could lead to consensus
forks.

SuperAxeCoin Core released binaries from https://superaxecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~superaxecoin/+archive/ubuntu/superaxecoin
- A third-party or self-compiled SuperAxeCoin Core

upgrade to SuperAxeCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
