/* src/config/superaxecoin-config.h.  Generated from superaxecoin-config.h.in by configure.  */
/* src/config/superaxecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef SUPERAXECOIN_CONFIG_H

#define SUPERAXECOIN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The SuperAxeCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "SuperAxeCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/superaxecoin/superaxecoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "SuperAxeCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SuperAxeCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "superaxecoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://superaxecoincore.org/"
