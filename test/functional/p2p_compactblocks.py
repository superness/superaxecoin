...
# TestP2PConn: A peer we use to send messages to superaxecoind, and store responses.
...
class CompactBlocksTest(SuperAxeCoinTestFramework):
    ...
    # This test actually causes superaxecoind to (reasonably!) disconnect us, so do this last.
    ...
    # superaxecoind's choice of nonce.
    ...
    # Test that superaxecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for superaxecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # superaxecoind will not send blocktxn responses for blocks whose height is
