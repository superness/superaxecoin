SuperAxeCoin Core version 0.16.1 is now available from:

  <https://superaxecoincore.org/bin/superaxecoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting superaxecoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure superaxecoind processes are cleaned up when tests end (sdaftuar)
