...
#ifndef SUPERAXECOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define SUPERAXECOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // SUPERAXECOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
