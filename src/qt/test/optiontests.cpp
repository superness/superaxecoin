...
{
    // Test regression https://github.com/superaxecoin/superaxecoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/superaxecoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/superaxecoin-core/gui/pull/568.
    // With fListen=false in ~/.config/SuperAxeCoin/SuperAxeCoin-Qt.conf and all else left as default,
    // superaxecoin-qt should set both -listen and -listenonion to false and start successfully.
