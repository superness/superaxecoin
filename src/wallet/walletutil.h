// Copyright (c) 2017-2021 The SuperAxeCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef SUPERAXECOIN_WALLET_WALLETUTIL_H
#define SUPERAXECOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! superaxecoin from opening the wallet, thinking it was newly created, and
...
#endif // SUPERAXECOIN_WALLET_WALLETUTIL_H
