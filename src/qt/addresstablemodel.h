...
#ifndef SUPERAXECOIN_QT_ADDRESSTABLEMODEL_H
#define SUPERAXECOIN_QT_ADDRESSTABLEMODEL_H
...
public:
    ...
    enum ColumnIndex {
        ...
        Address = 1  /**< SuperAxeCoin address */
    };
...
#endif // SUPERAXECOIN_QT_ADDRESSTABLEMODEL_H
