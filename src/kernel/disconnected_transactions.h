...
#ifndef SUPERAXECOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define SUPERAXECOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // SUPERAXECOIN_KERNEL_DISCONNECTED_TRANSACTIONS_H
