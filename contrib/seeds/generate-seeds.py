...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef SUPERAXECOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define SUPERAXECOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the superaxecoin network\n')
    ...
    g.write('#endif // SUPERAXECOIN_CHAINPARAMSSEEDS_H\n')
