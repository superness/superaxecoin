...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SuperAxeCoinTestFramework
    pass


class ExampleTest(SuperAxeCoinTestFramework):
    # Each functional test is a subclass of the SuperAxeCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        SuperAxeCoinTestFramework class so other tests can use it."""
