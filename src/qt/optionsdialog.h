...
#ifndef SUPERAXECOIN_QT_OPTIONSDIALOG_H
#define SUPERAXECOIN_QT_OPTIONSDIALOG_H
...
private Q_SLOTS:
    ...
    void on_openSuperAxeCoinConfButton_clicked();
...
#endif // SUPERAXECOIN_QT_OPTIONSDIALOG_H
