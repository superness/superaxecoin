...
#ifndef SUPERAXECOIN_COMPAT_ASSUMPTIONS_H
#define SUPERAXECOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "SuperAxeCoin cannot be compiled without assertions."
#endif
...
#endif // SUPERAXECOIN_COMPAT_ASSUMPTIONS_H
