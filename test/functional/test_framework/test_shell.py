...
class TestShell:
    """Wrapper Class for SuperAxeCoinTestFramework.

    The TestShell class extends the SuperAxeCoinTestFramework
    ...
    class __TestShell(SuperAxeCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by SuperAxeCoinTestFramework child class.
            self.num_nodes = 1
