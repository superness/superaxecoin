...
// Copyright 2015 SuperAxeCoin Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef SUPERAXECOIN_UNIVALUE_INCLUDE_UNIVALUE_H
#define SUPERAXECOIN_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // SUPERAXECOIN_UNIVALUE_INCLUDE_UNIVALUE_H
