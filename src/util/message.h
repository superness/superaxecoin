...
#ifndef SUPERAXECOIN_UTIL_MESSAGE_H
#define SUPERAXECOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's superaxecoin address, it must refer to a public key.
...
#endif // SUPERAXECOIN_UTIL_MESSAGE_H
