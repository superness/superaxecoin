...
#ifndef SUPERAXECOIN_SCRIPT_SCRIPT_H
#define SUPERAXECOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, SuperAxeCoin always counted CHECKMULTISIGs
...
#endif // SUPERAXECOIN_SCRIPT_SCRIPT_H
