#!/usr/bin/env python3
# Copyright (c) 2019-2021 The SuperAxeCoin Core developers
...
class TxDownloadTest(SuperAxeCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new superaxecoind instances, as setting mocktimes has long-term effects on when
