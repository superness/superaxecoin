// Copyright (c) 2019-2020 The SuperAxeCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef SUPERAXECOIN_TEST_UTIL_TRANSACTION_UTILS_H
#define SUPERAXECOIN_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // SUPERAXECOIN_TEST_UTIL_TRANSACTION_UTILS_H
