...
#ifndef SUPERAXECOIN_HEADERSSYNC_H
#define SUPERAXECOIN_HEADERSSYNC_H
 ...
 *
 * The SuperAxeCoin protocol does not offer an easy way to determine the work on a
...
#endif // SUPERAXECOIN_HEADERSSYNC_H
