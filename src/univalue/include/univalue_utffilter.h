...
#ifndef SUPERAXECOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define SUPERAXECOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // SUPERAXECOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
