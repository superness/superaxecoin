...
SuperAxeCoin Core version 0.19.1 is now available from:

  <https://superaxecoincore.org/bin/superaxecoin-core-0.19.1/>
...
From SuperAxeCoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as SuperAxeCoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, SuperAxeCoin Core does not yet change appearance when
...
- #17488 fix "superaxecoind already running" warnings on macOS (fanquake)
