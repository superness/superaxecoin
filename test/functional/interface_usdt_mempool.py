...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/superaxecoin/superaxecoin/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(SuperAxeCoinTestFramework):
    ...
    def rejected_test(self):
        ...
        # https://github.com/superaxecoin/superaxecoin/issues/27380
