...
#ifndef SUPERAXECOIN_QT_WALLETMODEL_H
#define SUPERAXECOIN_QT_WALLETMODEL_H
...
/** Interface to SuperAxeCoin wallet from Qt view code. */
...
#endif // SUPERAXECOIN_QT_WALLETMODEL_H
