...
#ifndef SUPERAXECOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
#define SUPERAXECOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
...
#endif // SUPERAXECOIN_KERNEL_NOTIFICATIONS_INTERFACE_H
