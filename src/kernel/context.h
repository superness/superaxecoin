...
#ifndef SUPERAXECOIN_KERNEL_CONTEXT_H
#define SUPERAXECOIN_KERNEL_CONTEXT_H
...
//! passed to external libsuperaxecoin_kernel functions which need access to this
...
#endif // SUPERAXECOIN_KERNEL_CONTEXT_H
