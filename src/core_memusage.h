// Copyright (c) 2015-2018 The SuperAxeCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef SUPERAXECOIN_CORE_MEMUSAGE_H
#define SUPERAXECOIN_CORE_MEMUSAGE_H
...
#endif // SUPERAXECOIN_CORE_MEMUSAGE_H
