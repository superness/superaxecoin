Download URL: https://sourceforge.net/projects/superaxecoin/files/SuperAxeCoin/superaxecoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 AXE fee schedule (users still pay 0.01 AXE per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #superaxecoin00 - #superaxecoin99
