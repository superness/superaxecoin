SuperAxeCoin Core version 0.13.2 is now available from:

  <https://superaxecoin.org/bin/superaxecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update superaxecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow superaxecoin-tx to create v2 transactions (axedrak)
