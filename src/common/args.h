...
#ifndef SUPERAXECOIN_COMMON_ARGS_H
#define SUPERAXECOIN_COMMON_ARGS_H
...
extern const char * const SUPERAXECOIN_CONF_FILENAME;
extern const char * const SUPERAXECOIN_SETTINGS_FILENAME;
...
#endif // SUPERAXECOIN_COMMON_ARGS_H
