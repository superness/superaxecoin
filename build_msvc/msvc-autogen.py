...
libs = [
    'libsuperaxecoin_cli',
    'libsuperaxecoin_common',
    'libsuperaxecoin_crypto',
    'libsuperaxecoin_node',
    'libsuperaxecoin_util',
    'libsuperaxecoin_wallet_tool',
    'libsuperaxecoin_wallet',
    'libsuperaxecoin_zmq',
    'bench_superaxecoin',
    'libtest_util',
]
...
def parse_config_into_axe_config():
    ...
    config_dict["PACKAGE_STRING"] = f"\"SuperAxeCoin Core {version}\""

    with open(os.path.join(SOURCE_DIR,'../build_msvc/superaxecoin_config.h.in'), "r", encoding="utf8") as template_file:
    ...
    with open(os.path.join(SOURCE_DIR,'../build_msvc/superaxecoin_config.h'), "w", encoding="utf8") as axe_config:
        axe_config.writelines(template)
...
def main():
    parser = argparse.ArgumentParser(description='SuperAxeCoin-core msbuild configuration initialiser.')
    ...
    parse_config_into_axe_config()
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/superaxecoin_config.h'), os.path.join(SOURCE_DIR, 'config/superaxecoin-config.h'))
