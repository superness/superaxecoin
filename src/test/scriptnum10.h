...
#ifndef SUPERAXECOIN_TEST_SCRIPTNUM10_H
#define SUPERAXECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from SuperAxeCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // SUPERAXECOIN_TEST_SCRIPTNUM10_H
