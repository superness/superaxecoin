...
#ifndef SUPERAXECOIN_COMMON_SETTINGS_H
#define SUPERAXECOIN_COMMON_SETTINGS_H
...
//!       https://github.com/superaxecoin/superaxecoin/pull/15934/files#r337691812)
...
#endif // SUPERAXECOIN_COMMON_SETTINGS_H
