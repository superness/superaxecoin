...
#ifndef SUPERAXECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define SUPERAXECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // SUPERAXECOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
