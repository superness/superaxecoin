...
#ifndef SUPERAXECOIN_INTERFACES_INIT_H
#define SUPERAXECOIN_INTERFACES_INIT_H
...
//! (superaxecoin-gui, superaxecoin-node, superaxecoin-wallet, superaxecoind, superaxecoin-qt) and each
...
#endif // SUPERAXECOIN_INTERFACES_INIT_H
