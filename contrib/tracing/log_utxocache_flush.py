...
"""Example logging SuperAxeCoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/superaxecoind
...
def main(superaxecoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[superaxecoind_with_usdts])
