...
#ifndef SUPERAXECOIN_INTERFACES_NODE_H
#define SUPERAXECOIN_INTERFACES_NODE_H
...
//! Top-level interface for a superaxecoin node (superaxecoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or superaxecoin.conf.
...
#endif // SUPERAXECOIN_INTERFACES_NODE_H
