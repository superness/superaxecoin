...
By default, superaxecoind will dump mempool on shutdown and
...
class MempoolPersistTest(SuperAxeCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent superaxecoind from writing mempool.dat to disk. Verify that `savemempool` fails")
