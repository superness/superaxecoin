...
class TxnMallTest(SuperAxeCoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 AXE:
        ...
        # First: use raw transaction API to send 1240 AXE to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 AXE coin each
        ...
        # Node0's balance should be starting balance, plus 50AXE for another
        ...
        # Node0's total balance should be starting balance, plus 100AXE for
