// Copyright (c) 2012-2022 The SuperAxeCoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.superaxecoincore.org", "www.superaxecoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.superaxecoincore.org]", "www.superaxecoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.superaxecoincore.org:80", "www.superaxecoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.superaxecoincore.org]:80", "www.superaxecoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.superaxecoincore.org:65536", "www.superaxecoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.superaxecoincore.org:0", "www.superaxecoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.superaxecoincore.org:", "www.superaxecoincore.org:", 0, false));
}
