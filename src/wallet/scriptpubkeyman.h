...
#ifndef SUPERAXECOIN_WALLET_SCRIPTPUBKEYMAN_H
#define SUPERAXECOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The SuperAxeCoin Core wallet was originally a collection of unrelated private
...
#endif // SUPERAXECOIN_WALLET_SCRIPTPUBKEYMAN_H
