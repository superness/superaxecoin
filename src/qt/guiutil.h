...
#ifndef SUPERAXECOIN_QT_GUIUTIL_H
#define SUPERAXECOIN_QT_GUIUTIL_H
...
/** Utility functions used by the SuperAxeCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "superaxecoin:" URI into recipient object, return true on successful parsing
...
#endif // SUPERAXECOIN_QT_GUIUTIL_H
